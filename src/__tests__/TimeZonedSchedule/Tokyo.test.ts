...
describe('TimeZonedSchedule for Tokyo', () => {
  ...
  describe('Daily Schedule', () => {
    test('should generate daily events with DST adjustment', () => {
      ...
      const expectedUTC = ['2024-03-09T08:00:00', '2024-03-10T08:00:00', '2024-03-11T08:00:00']
    ...
    test('should handle single day schedule', () => {
      ...
      expect(tzs.utcToLocal(events[0], { return: 'timestamp' })).toBe('2024-01-01T17:00:00')
    })
  })
  ...
  describe('Weekly Schedule', () => {
    test('should generate weekly events for specified days with DST adjustment', () => {
      ...
      const expectedLocalTimes = ['2024-03-04T17:00:00', '2024-03-11T17:00:00']
