...
describe("TimeZoned", () => {
  ...
  describe("Los Angeles", () => {
    ...
    describe("Local to UTC", () => {
      ...
      it("handles different return formats", () => {
        ...
        expect(tz.localToUtc(localTime, { return: "string", returnFormat: "12" }))
          .toBe("2024-01-01T08:00:00 AM");
      });
    });
  });
  ...
  describe("Error Handling", () => {
    it("throws error for invalid timezone", () => {
      expect(() => new TimeZoned({ timeZone: "Invalid/Timezone" }))
  ...
  describe("New York", () => {
    ...
    describe("Local to UTC", () => {
      it("converts NY time to UTC with various formats", () => {
        ...
        expect(tz.localToUtc(localTime, { return: "timestamp" }))
          .toBe("2024-01-01T05:00:00");
        expect(tz.localToUtc(localTime, { return: "date" }))
          .toBe("2024-01-01");
        expect(tz.localToUtc(localTime, { return: "time" }))
          .toBe("05:00:00");
        expect(tz.localToUtc(localTime, { return: "string", returnFormat: "MM/DD/YYYY HH:mm:ss" }))
